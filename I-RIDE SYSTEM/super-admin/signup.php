...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO users (name, mobile, Address, email, username, password, role) 
            VALUES ('$name', '$mobile', '$Address', '$email', '$username', '$hashed_password', '$role')";
    ...
    <script>
        ...
        function checkPasswordStrength(password) {
            ...
            // For example, you can check the length, presence of uppercase, lowercase, digits, and special characters
            // For simplicity, let's assume a password is weak if it's less than 6 characters,
            // moderate if it's between 6 and 10 characters, and strong if it's more than 10 characters.
